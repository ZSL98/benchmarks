...
extern "C" __launch_bounds__(64) __global__ void Pad_float_float_float_cuda_Pad_122(float* input0, float* input1, float* output0)
{
    ...
    if (tid < 6422528)
    {
        ...
        uint32_t input_strides0 = 802816;
        uint32_t input_strides1 = 3136;
        uint32_t input_strides2 = 56;
        uint32_t input_strides3 = 1;
        uint32_t output_strides0 = 802816;
        uint32_t output_strides1 = 3136;
        uint32_t output_strides2 = 56;
...
extern void Pad_float_float_float_cuda_Pad_122_Call(const dim3 &grids, const dim3 &blocks, unsigned mem, cudaStream_t stream, float* input0, float* input1, float* output0) {
    Pad_float_float_float_cuda_Pad_122<<<grids, blocks, mem, stream>>>(input0, input1, output0);
}
